...
function LodingScript()
    ...
    local _http_request = (syn and syn.request) or (http and http.request) or http_request or (fluxus and fluxus.request) or request
    ...
    function Library:CreateWindow(...)
        ...
        if true then task.spawn(Library.Toggle) end
    ...
    local ThemeManager = {} do
        ...
        ThemeManager.BuiltInThemes = {                                      --05d1e5
            ...
            ['x2Swiftz'] 			= { 9, httpService:JSONDecode('{"MainColor":"1e1e1e","AccentColor":"fec1ff","OutlineColor":"141414","BackgroundColor":"232323","FontColor":"ffffff"}') },
            ['Xenon Hub'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"242323","AccentColor":"07a5ff","BackgroundColor":"2f2b2b","OutlineColor":"302b2b"}') },
        }
    ...
    local SaveManager = {} do
        SaveManager.Folder = 'Xenon Hub Next Generation'
        SaveManager.Ignore = {}
        SaveManager.Parser = {
            Toggle = {
...
LodingMarcoFile = function()
        ...
        if DataSave["Auto Swap Port Agency Portal"] and MapData.mode == "Detective Mission" then 
...
local Tabs = {
    ...
    General_2 = Window:AddTab('Main',true), 
...
Tab002 = TabMain002:AddTab("[ Challenges ]")
...
Tab004 = TabMain004:AddTab("[ Infinite Mode ]")
...
Tab005 = TabMain005:AddTab("[ Infinite Castle ]")
...
Tab006 = TabMain006:AddTab("[ Legend Stage ]")
...
Tab006:AddToggle('Toggle11h', {
    ...
    Tab007 = TabMain007:AddTab("[ Miscellaneous ]")
...
Tab009 = TabMain009:AddTab("[ Miscellaneous ]")
   ...
   --[[ Tab009:AddToggle('Toggle18', {
    ...
    Tab013 = TabMain013:AddTab("[ Craft Relics ]")
    ...
    Tab014 = TabMain014:AddTab("[ Capsule ]")
    ...
    Tab014:AddDropdown('MultiDropdown16Capsule', {
        ...
        Tab016 = TabMain016:AddTab("[ Remove Skins ]")
        ...
        Options.MultiDropdownportal3v:OnChanged(function()
            ...
            Tab018 = TabMain018:AddTab("[ Marco Panel ]")
            ...
            Tab018:AddDropdown('Dropdown10', {
                ...
                Tab018:AddDivider()
                Options.Label015 = Tab018:AddLabel(">> Settigs", true)
                
                Tab018:AddDropdown('Dropdown10z', {
                ...
                Tab018:AddDivider()
                Options.Label020 = Tab018:AddLabel("Action : 0/0", true)
                Tab018:AddToggle('Toggle33v', {
                    Text = 'Marco Play',
                ...
                Options.ASMCSS = Tab020:AddLabel("> Port Agency Portal", true)
                ...
                Tab020:AddDropdown('Dropdown14Port', {
                    ...
                    Tab020:AddToggle('Toggle34vxPort', {
                        Text = 'Auto Swap Port Agency Portal',
                ...
                Tab019:AddInput('Textbox3', {
                    ...
                    --[[TabMain019 = Tabs.Marco:AddRightTabbox('> Al Panel')
                    Tab019 = TabMain019:AddTab("\\\\ Al Panel //")
       ...
       Tab021:AddSlider('SliderGame1', {
        ...
        TabMain022 = Tabs.Game:AddLeftTabbox('> Game2')
        Tab022 = TabMain022:AddTab("[ Abilities Main ]")
        ...
        coroutine.wrap(function()
            while true do wait()
                ...
                if hours > 0 then
                    Library:SetWatermark("Welcome to Xenon Hub, Bind UI (F1) | "..hours.." Hour(s), "..minutes.." Minute(s), "..math.floor(seconds).." Second(s)")
                elseif minutes > 0 then
                    Library:SetWatermark("Welcome to Xenon Hub, Bind UI (F1) | "..minutes.." Minute(s), "..math.floor(seconds).." Second(s)")
                else
                    Library:SetWatermark("Welcome to Xenon Hub, Bind UI (F1) | "..math.floor(seconds).." Second(s)")
                end
            end)
        end
    end)()
                        ...
                        if v:FindFirstChild("Players") then 
                            if Service[8].PlayerGui.LevelSelectGui.Enabled == false then 
                                if not v["Players"]:FindFirstChildOfClass("ObjectValue") then
                                    ...
                                    firetouchinterest(v["Door"],Service[8].Character.HumanoidRootPart,0)
                                    task.wait(.1)
                                    firetouchinterest(v["Door"],Service[8].Character.HumanoidRootPart,1)
